    ...
    if uploaded_file:
        try:
            ...
            **CAGR (Tasa de Crecimiento Anual Compuesto)**
            ...
            Al analizar los datos de producción de energía solar en Colombia, se observó un crecimiento extraordinario durante el mes 4 de 2024, cuando la generación se triplicó de 1,000 GWh a 3,000 GWh (un aumento del 200%). Este salto se puede explicar por la confluencia de varios factores:
            ...
            - En abril se inaguraron 7 plantas (mirar documento de la pagina 28)
            # Referencias
