    ...
    if uploaded_file:
        try:
            ...
            **CAGR (Tasa de Crecimiento Anual Compuesto)**
            ...
            Al analizar los datos de producción de energía solar en Colombia, se observó un crecimiento extraordinario durante el mes Octubre de 2024, cuando la generación se duplicó de 2,095 Millones de GWh en Enero del 2024 a 4,425 Millones de GWh en Octubre del 2024 (un aumento de más del 200%). Este salto se puede explicar por la confluencia de varios factores:
